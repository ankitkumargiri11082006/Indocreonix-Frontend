...
const roleConfigMap = {
  internship: {
    ...
    heroSubtitle:
      "Apply for internship opportunities at Indocreonix and gain practical experience on real projects.",
    metrics: [
    ...
    formSubtitle:
      "Complete this form with accurate details. Our team will review and contact shortlisted candidates.",
    successMessage:
      "Internship application submitted successfully. Our team will review and connect with you.",
  },
  job: {
    heroTitle: "Job Application",
    heroSubtitle:
      "Apply for full-time opportunities at Indocreonix and contribute to client and internal product delivery.",
    metrics: [
    ...
    formSubtitle:
      "Complete this form with your latest profile details. Our hiring team will review and respond.",
    successMessage:
      "Job application submitted successfully. Our hiring team will connect with shortlisted candidates.",
  },
};
