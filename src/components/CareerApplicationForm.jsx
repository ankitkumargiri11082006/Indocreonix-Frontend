  ...
  const onSubmit = async (event) => {
    ...
    if (!portalToken || !portalUser?.email) {
      setModalState({
        ...
        message:
          "Please sign in to your portal account before applying for careers.",
        type: "error",
      });
      return;
    }
    ...
    if (!cvFile) {
      setModalState({
        ...
        message:
          "Please upload your CV in PDF format (max 2MB) to proceed with your application.",
        type: "error",
      });
      return;
    }
    ...
    if (cvFile.size > 2 * 1024 * 1024) {
      setModalState({
        ...
        message:
          "The CV file size exceeds our 2MB limit. Please compress your PDF and try again.",
        type: "error",
      });
      return;
    }
    ...
    if (!cvFile.name.toLowerCase().endsWith(".pdf")) {
      setModalState({
        ...
        message:
          "Only PDF documents are accepted for CV uploads. Please convert your file to PDF.",
        type: "error",
      });
      return;
    }
    ...
    if (!formData.consentAccepted) {
      setModalState({
        ...
        message:
          "Please review and accept Indocreonix Terms and Privacy Policy to submit your application.",
        type: "error",
      });
      return;
    }
    ...
    try {
      ...
      setModalState({
        ...
        message:
          "Thank you for your interest in joining Indocreonix. Your application has been successfully submitted to our HR department. Our hiring team will carefully review your profile and contact you soon if your skills and experience align with our requirements.",
        type: "success",
      });
      ...
      setModalState({
        ...
        message:
          ...
          "We encountered an error while submitting your application. Please try again or email your CV directly to our careers mailbox.",
        type: "error",
      });
    } finally {
      setLoading(false);
